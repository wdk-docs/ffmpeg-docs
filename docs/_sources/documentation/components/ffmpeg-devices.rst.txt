...
4.3.1 Options
list_devices
If set to true, print a list of devices and exit. Defaults to false. Alternatively you can use the -sinks option of ffmpeg to list the available output devices.
